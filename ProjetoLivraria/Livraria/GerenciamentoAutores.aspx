<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GerenciamentoAutores.aspx.cs" 
    Inherits="ProjetoLivraria.Livraria.GerenciamentoAutores" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row" style="text-align: left;">
        <h2>Cadastro Novo Autor</h2>
        <table>
            <tr style="display: grid;">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                        ControlToValidate="tbxCadastroSobrenomeAutor" Style="color: red;" ErrorMessage="* Digite o sobrenome do
                        autor."></asp:RequiredFieldValidator>
                </td>
                <td>
                ...
                <td>
                    <asp:Button ID="btnNovoAutor" runat="server" CssClass="btn btn-success" Style="margin-top: 10px" Text="Salvar"
        ...
        <asp:GridView ID="gvGerenciamentoAutores" runat="server" Width="100%" AutoGenerateColumns="False" Font-Size="14px" CellPadding="4" 
            ...
            <Columns>
                <asp:TemplateField Visible="false">
                    ...
                    <HeaderTemplate>
                        <asp:Label ID="lblTextIdAutor" runat="server" Text="ID"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblIdAutor" runat="server" Text='<%# Eval("aut_id_autor") %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="tbxEditNomeAutor" runat="server" CssClass="form-control" Height="35px" MaxLength="15" 
                            Text='<%# Eval("aut_nm_nome") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <HeaderTemplate>
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="tbxEditSobrenomeAutor" runat="server" CssClass="form-control" Height="35px" MaxLength="45" 
                ...
                <asp:TemplateField>
                    <EditItemTemplate>
                        <asp:TextBox ID="tbxEditEmailAutor" runat="server" CssClass="form-control" Height="35px" MaxLength="50" 
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Button ID="btnCarregaLivrosAutor" runat="server" CssClass="btn btn-primary" Text="Livros" CommandName="CarregaLivrosAutor"
